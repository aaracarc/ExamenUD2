...
class TestExamenStream {
    ...
    void test1() {
        ...
        try {
            ...
            //TODO STREAMS
            var solList = list.stream().filter(oficina -> oficina.getPais().equals("España")).map(Oficina::getCiudad);
    ...
    void test5() {
        ...
        try {
            ...
            //TODO STREAMS
            var solList = list.stream().filter(cliente -> !(cliente.getPais().equals("España"))).map(Cliente::getNombreCliente);
